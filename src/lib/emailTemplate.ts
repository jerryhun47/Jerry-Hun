export const getOrderReceivedEmail = (customerName: string, orderItems: string, totalPrice: string | number) => {
  return `<!DOCTYPE html>
<html>
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0b0f19; margin: 0; padding: 0; color: #cbd5e1;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #111827; border: 1px solid #1f2937; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
        ...
        <div style="padding: 30px;">
            <h2 style="color: #ffffff; margin-top: 0; font-size: 22px; font-weight: 700;">Order Received</h2>
            ...
            <div style="background-color: #0f172a; border: 1px solid #1f2937; border-radius: 12px; padding: 20px; margin: 25px 0;">
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px 0; color: #f59e0b; text-align: right; font-weight: bold; text-transform: uppercase;">PENDING</td>
                    </tr>
                </table>
            </div>
            <p style="color: #94a3b8; font-size: 14px; line-height: 1.5;">If you face any issues, feel free to reply to this email.</p>
...
export const getOrderConfirmedEmail = (customerName: string, orderItems: string, totalPrice: string | number, productGmail?: string, productPassword?: string) => {
  return `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"></head>
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0b0f19; margin: 0; padding: 0; color: #cbd5e1;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #111827; border: 1px solid #1f2937; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
        ...
        <div style="padding: 30px;">
            <h2 style="color: #ffffff; margin-top: 0; font-size: 22px; font-weight: 700;">Order Confirmed</h2>
            <p style="color: #cbd5e1; line-height: 1.6; font-size: 15px;">
                Dear <strong>${customerName}</strong>,<br>
                Your order has been confirmed successfully! Below are your product access details.
            </p>
            ${productGmail && productPassword ? `
            ...
            <div style="background-color: #0f172a; border: 1px solid #1f2937; border-radius: 12px; padding: 20px; margin: 25px 0;">
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    ...
                    <tr style="border-bottom: 1px solid #1f2937;">
                        <td style="padding: 10px 0; color: #94a3b8;">Price Paid:</td>
                        <td style="padding: 10px 0; color: #ffffff; text-align: right; font-weight: bold;">PKR ${totalPrice}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0; color: #94a3b8;">Status:</td>
                        <td style="padding: 10px 0; color: #10b981; text-align: right; font-weight: bold; text-transform: uppercase;">CONFIRMED</td>
                    </tr>
                </table>
            </div>
            <p style="color: #94a3b8; font-size: 14px; line-height: 1.5;">Please keep these details secure. If you face any issues, feel free to reply to this email.</p>
            <p style="color: #cbd5e1; font-size: 14px; margin-top: 25px;">Best Regards,<br><strong style="color: #ffffff;">Jerry Automation Team</strong></p>
        </div>
        <div style="background-color: #0f172a; padding: 20px; text-align: center; font-size: 12px; color: #64748b; border-top: 1px solid #1f2937;">
            <p style="margin: 0;">Support Email: <a href="mailto:contact@jerryautomation.com" style="color: #ef4444; text-decoration: none; font-weight: bold;">contact@jerryautomation.com</a></p>
...
export const getRefundRequestedEmail = (customerName: string, itemName: string, totalPrice: string | number, refundMethod: string, accountNumber: string, accountTitle: string) => {
  return `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"></head>
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0b0f19; margin: 0; padding: 0; color: #cbd5e1;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #111827; border: 1px solid #1f2937; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
        ...
        <div style="padding: 30px;">
            <h2 style="color: #ffffff; margin-top: 0; font-size: 22px; font-weight: 700;">Refund Request Received</h2>
            <p style="color: #cbd5e1; line-height: 1.6; font-size: 15px;">
                Dear <strong>${customerName}</strong>,<br>
            ...
            <div style="background-color: #0f172a; border: 1px solid #1f2937; border-radius: 12px; padding: 20px; margin: 25px 0;">
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    ...
                    <tr style="border-bottom: 1px solid #1f2937;">
                        <td style="padding: 10px 0; color: #94a3b8;">Account Title:</td>
                        <td style="padding: 10px 0; color: #ffffff; text-align: right; font-weight: bold;">${accountTitle}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0; color: #94a3b8;">Status:</td>
                        <td style="padding: 10px 0; color: #f59e0b; text-align: right; font-weight: bold; font-size: 15px;">UNDER REVIEW</td>
                    </tr>
                </table>
            </div>
...
export const getRefundProcessedEmail = (customerName: string, itemName: string, totalPrice: string | number, status: string, refundMethod: string, accountNumber: string, accountTitle: string, rejectRemarks?: string) => {
...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0b0f19; margin: 0; padding: 0; color: #cbd5e1;">
    <div style="max-width: 600px; margin: 30px auto; background-color: #111827; border: 1px solid #1f2937; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
        ...
        <div style="padding: 30px;">
            <h2 style="color: #ffffff; margin-top: 0; font-size: 22px; font-weight: 700;">${isRefunded ? 'Refund Successful' : 'Refund Rejected'}</h2>
            <p style="color: #cbd5e1; line-height: 1.6; font-size: 15px;">
                Dear <strong>${customerName}</strong>,<br>
                ${isRefunded ? 'Good news! Your refund request has been approved and the funds have been transferred.' : 'Your refund request has been reviewed by our team and could not be processed.'}
            </p>
            ${!isRefunded && rejectRemarks ? `
            ...
            <div style="background-color: #0f172a; border: 1px solid #1f2937; border-radius: 12px; padding: 20px; margin: 25px 0;">
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    ...
                    <tr>
                        <td style="padding: 10px 0; color: #94a3b8;">Status:</td>
                        <td style="padding: 10px 0; color: ${isRefunded ? '#10b981' : '#ef4444'}; text-align: right; font-weight: bold; font-size: 15px; text-transform: uppercase;">${isRefunded ? 'REFUNDED' : status}</td>
                    </tr>
                </table>
            </div>
            <p style="color: #cbd5e1; font-size: 14px; margin-top: 20px;">Best Regards,<br><strong style="color: #ffffff;">Jerry Automation Team</strong></p>
