    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
      ...
      >
        <div className="w-[160px] h-[160px] md:w-[240px] md:h-[240px] bg-white rounded-[3rem] flex items-center justify-center mb-8 md:mb-12 rotate-12 overflow-hidden shadow-2xl">
           <img src="/logo.png" alt="Background Logo" width="200" height="200" className="w-[80%] h-[80%] object-contain" />
        </div>
        <span className="font-extrabold text-[15vw] md:text-[10vw] whitespace-nowrap text-white tracking-tighter">
          Jerry <span className="text-primary-500 font-extrabold">Automation</span>
        </span>
      </motion.div>
      ...
      {bubbles.map(bubble => (
        <motion.div
          key={bubble.id}
          className="absolute bottom-[-100px] rounded-full bg-primary-500 blur-md pointer-events-none"
          style={{
            left: bubble.left,
            width: bubble.size,
            height: bubble.size,
